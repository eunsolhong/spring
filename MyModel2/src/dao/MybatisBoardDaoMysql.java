...
public class MybatisBoardDaoMysql extends AbstractRepository{
	...
	private static MybatisBoardDaoMysql 
	instance = new MybatisBoardDaoMysql();
	...
	public List<BoardDataBean> getArticles(int startRow, int endRow, 
		...
		SqlSession sqlSession = getSqlSessionFactory().openSession();
		try {			String statement = namespace + ".getArticles";
	...
	public int deleteArticle(int num, String passwd) throws Exception {
		...
		} finally {		sqlSession.close();		}		return x;	}
}//class end
