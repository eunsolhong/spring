...
<div class="w3-container">
	...
	<form method="post" name="writeform" enctype="multipart/form-data"
		...
		<input type="hidden" name="num" value="${article.num}"> <input
			type="hidden" name="ref" value="${article.ref}"> <input
			type="hidden" name="re_step" value="${article.re_step }"> <input
			type="hidden" name="re_level" value="${article.re_level }">
		<table class="w3-table-all" style="width: 70%;">
			...
			<tr>
				...
				<td width="330"><c:if test="${article.num==0}">
						<input type="text" size="40" maxlength="50" name="subject">
					</c:if> <c:if test="${article.num!=0}">
